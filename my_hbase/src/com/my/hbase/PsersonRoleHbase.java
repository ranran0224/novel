...
public class PsersonRoleHbase {
	public static String TN_PERSON = "person";
	public static String TN_ROLE = "role";
	...
	public void before() throws MasterNotRunningException, ZooKeeperConnectionException, IOException {
		...
		hTable = new HTable(conf, TN_PERSON);
	}
	...
	public void createTable() throws IOException{
		//step1 判断表是否存在，存在删除
		if(hAdmin.tableExists(TN_PERSON)){
			hAdmin.disableTable(TN_PERSON);
			hAdmin.deleteTable(TN_PERSON);
		}
		//step2 创建table description
		HTableDescriptor desc = new HTableDescriptor(TableName.valueOf(TN_PERSON));
